...
class WP_K5N_Subscribers_Groups_List_Table extends WP_List_Table {
    ...
    function column_default($item, $column_name) {
        switch ($column_name) {
            ...
            case 'total_subscribers':
                return wps_get_total_subscribe($item['ID']);
    ...
    function prepare_items() {
         ...
         */
        $per_page = isset($this->option['groups_page_size']) ? $this->option['groups_page_size'] : '15';
